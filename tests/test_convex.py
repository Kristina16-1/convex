        ...
        assert self.f.add(
            ...
            R2Point(
                ...
                2.0)).add(
                    R2Point(
                        2.0,
                        1.0)).sqer() == approx(10.0)

    def test_sqer1(self):
        assert self.f.add(R2Point(1.0, 1.0)).sqer() == approx(4.0)
